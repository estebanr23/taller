          ...
          <tbody>
            @forelse ($brands as $brand)
              <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ $brand->id }}</td>
                <td class="whitespace-nowrap px-3 py-3 font-medium text-slate-700 dark:text-navy-100 lg:px-5">{{ $brand->brand_name }}</td>
                  ...
                  <span>
                    <div class="flex justify-start space-x-2">
                      <button 
                        ...
                        wire:click="$emitTo('brands.brand-edit', 'edit', {{ $brand->id }})" 
                      ...
                      <button 
                        ...
                        wire:click="$emitTo('brands.brand-delete', 'delete', {{ $brand }})" 
                      ...
                      <button 
                        ...
                        wire:click="$emitTo('brands.brand-delete', 'restore', {{ $brand->id }})" 
